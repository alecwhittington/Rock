...
namespace Rock.Blocks.CheckIn
{
    ...
    /// </summary>
    [DisplayName( "Attendance History List" )]
    [Category( "Check-in" )]
    ...
    public class AttendanceHistoryList : RockEntityListBlockType<Attendance>
    {
        ...
        private static class PreferenceKey
        {
            ...
            public const string FilterDidAttended = "filter-did-attended";
        }
        ...
        /// </summary>
        /// <value>
        /// The DidAttended filter.
        /// </value>
        protected string FilterDidAttended => GetBlockPersonPreferences()
            .GetValue( PreferenceKey.FilterDidAttended );
        ...
        protected override IQueryable<Attendance> GetListQueryable( RockContext rockContext )
        {
            ...
            // Filter by DidAttend
            if ( FilterDidAttended.IsNotNullOrWhiteSpace() )
            {
                var didAttend = FilterDidAttended.AsBoolean();
