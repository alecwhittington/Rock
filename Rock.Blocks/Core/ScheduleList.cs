...
namespace Rock.Blocks.Core
{
    ...
    public class ScheduleList : RockEntityListBlockType<Schedule>
    {
        ...
        {
            return BlockCache.IsAuthorized( Authorization.EDIT, RequestContext.CurrentPerson ) && GetAttributeValue( AttributeKey.DetailPage ).IsNotNullOrWhiteSpace();
        }
        ...
        protected override IQueryable<Schedule> GetListQueryable( RockContext rockContext )
        {
            ...
            {
                categoryGuid = GetCategoryGuid();
            }
            else
            {
                categoryGuid = FilterCategory;
            }
            ...
            if ( !string.IsNullOrWhiteSpace( FilterActiveStatus ) && FilterActiveStatus != "all" )
            {
            ...
            var displayedScheduleIds = queryable.Select( a => a.Id ).ToList();
        ...
        {
            return queryable.ToList().OrderByOrderAndNextScheduledDateTime();
        }
        ...
        protected override GridBuilder<Schedule> GetGridBuilder()
        {
            return new GridBuilder<Schedule>()
                ...
                .AddField( "hasAttendance", a => HasAttendance( a.Id ) )
                .AddField( "isActive", a => a.IsActive );
        }

        /// <summary>
        /// Determines whether the specified Schedule has attendance.
        /// </summary>
        /// <param name="id">The id.</param>
        /// <returns>
        ///   <c>true</c> if the specified Schedule has attendance; otherwise, <c>false</c>.
        /// </returns>
        private bool HasAttendance( int id )
        {
            return _schedulesWithAttendance.Contains( id );
        }
