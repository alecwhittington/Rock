...
namespace Rock.Lava
{
    ...
    internal static partial class LavaFilters
    {
        ...
        public static object GuidToId( ILavaRenderContext context, object input, string entityType )
        {
            ...
            if ( !isValidInput )
            {
                throw LavaElementRenderException.New( nameof( GuidToId ) )
                    .WithMessage( "Invalid Input Guid Value." )
            ...
            var inputInteger = InputParser.TryConvertInteger( entityType, null, null );
