...
namespace Rock.Lava
{
    ...
    {
        /// <summary>
        /// Sets the error message for the target Exception.
        /// </summary>
        /// <param name="exception"></param>
        /// <param name="message"></param>
        /// <returns></returns>
        public static LavaElementRenderException WithMessage( this LavaElementRenderException exception, string message )
        {
            if ( exception != null )
            {
