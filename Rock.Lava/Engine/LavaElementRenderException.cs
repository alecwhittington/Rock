...
namespace Rock.Lava
{
    ...
    public class LavaElementRenderException : LavaException
    {
        ...
        public LavaElementRenderException( string elementName )
        {
        ...
        public static LavaElementRenderException New( string elementName )
        {
            return new LavaElementRenderException( elementName );
        }
