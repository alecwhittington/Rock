                ...
                <div class="panel-body">
                    ...
                    <div id="pnlEditDetails" runat="server">
                        ...
                        <Rock:PanelWidget ID="wpMemberAttributes" runat="server" Title="Member Attributes">
                            ...
                            <Rock:RockControlWrapper ID="rcMemberAttributesInherited" runat="server" Label="Inherited Attribute(s)">
                                <div class="grid">
                            ...
                            <div class="grid">
                                <Rock:Grid ID="gMemberAttributes" runat="server" AllowPaging="false" DisplayType="Light" RowItemText="Member Attribute">
                                    <Columns>
                                        <Rock:ReorderField />
                        ...
                        <Rock:PanelWidget ID="wpMemberOpportunityAttributes" runat="server" Title="Member Opportunity Attributes">
                            ...
                            <div class="grid">
                                <Rock:Grid ID="gMemberOpportunityAttributes" runat="server" AllowPaging="false" DisplayType="Light" RowItemText="Member Opportunity Attribute">
                                    <Columns>
                                        <Rock:ReorderField />
                                        <Rock:RockBoundField DataField="Name" HeaderText="Attribute" />
                                        <Rock:RockBoundField DataField="Description" HeaderText="Description" />
