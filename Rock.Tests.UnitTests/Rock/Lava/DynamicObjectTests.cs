...
namespace Rock.Tests.UnitTests.Lava
{
    ...
    public class DynamicObjectTests : LavaUnitTestBase
    {
        ...
        /// </summary>
        [TestMethod]
        public void LavaDataObjectType_ProxiedObjectDecoratedWithLavaHiddenProperty_HidesDecoratedProperty()
        {
            var mergeValues = new LavaDataDictionary { { "CurrentPerson", GetLavaDataObjectTestPersonTedDecker() } };

            TestHelper.AssertTemplateOutput( string.Empty, "{{ CurrentPerson.Password }}", mergeValues );
        }
